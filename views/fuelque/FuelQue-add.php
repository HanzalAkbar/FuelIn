            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="../FuelQue.php" method="POST">
                        <div class="mb-3">
                            <label for="">NIC</label>
                            <input pattern="[0-9]{9,11}-V" maxlength="12" type="text" name="nic" required class="form-control"/>
                        </div>
                        <div class="mb-3">
                            <label for="">Vehicle Number</label>
                            <input pattern="[A-Za-z0-9]{2,3}-[A-Za-z0-9]{3,4}" maxlength="8" type="text" name="vehiclenumber" required class="form-control"/>
                        </div>
                        <div class="mb-3">
