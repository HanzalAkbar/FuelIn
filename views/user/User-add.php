                ...
                <div class="card-body">
                    ...
                    <form action="../User.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" maxlength="50" type="email" name="email" required class="form-control"/>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" maxlength="50" type="password" name="password" required class="form-control"/>
                        </div>
                        <div class="mb-3">
