                        ...
                        if ($result) {
                            ...
                            <form action="../User.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" maxlength="50" value="<?= $result['Email'] ?>" type="email" name="email" required
                                           class="form-control"/>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" value="<?= $result['Password'] ?>" type="password" name="password" required
                                           class="form-control"/>
                                </div>
                                <div class="mb-3">
